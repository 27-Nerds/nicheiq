...
class UnifiedSolutionCrew:
    ...
    def _angle_static_prompt(self) -> tuple[str, dict]:
        ...
        static_prompt = (
            ...
            "strings are shown to end users. Refer to the angle in plain English — 'distribution / SEO', 'novel "
            "differentiation' (or 'novel mechanism'), or 'vertical workflow'. NEVER write the internal identifiers "
