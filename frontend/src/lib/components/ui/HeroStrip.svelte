<script lang="ts">
	...
	let { children, primary, variant = 'default', class: className = '' }: Props = $props();
</script>
...
<style>
	...
	.hero-strip__rail > :global(*:nth-child(1)) { animation-delay: 0.05s; }
	.hero-strip__rail > :global(*:nth-child(2)) { animation-delay: 0.1s; }
	.hero-strip__rail > :global(*:nth-child(3)) { animation-delay: 0.15s; }
	.hero-strip__rail > :global(*:nth-child(4)) { animation-delay: 0.2s; }
	.hero-strip__rail > :global(*:nth-child(5)) { animation-delay: 0.25s; }
