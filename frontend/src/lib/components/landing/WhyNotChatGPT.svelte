  ...
  const problems = [
    {
      ...
      nicheiq:
        "Direct community access: real-time posts, comments, engagement data",
      detail:
        "Perplexity and Grok can only find what Google indexes. NicheIQ connects directly to social platforms, accessing discussions, engagement metrics, and timestamps that web crawlers miss.",
    },
    {
      icon: Layers,
      ...
      detail:
        "Deep Research tools are general-purpose. NicheIQ is purpose-built for SaaS opportunity discovery: pain points → solutions → keywords → competitors → SEO strategy.",
    },
    {
      icon: Database,
      ...
      detail:
        "When Perplexity says a keyword is \"popular,\" it's guessing. When NicheIQ says 5,400 searches/month, that's real keyword data you can verify.",
    },
    {
      icon: FileText,
      title: "Chat vs. Professional Report",
      problem:
        "Conversational back-and-forth instead of structured deliverables",
      ...
      detail:
        "Chat responses require manual organization. NicheIQ delivers a professional report: executive summary, competitive analysis, SEO strategy, and GTM blueprint.",
    },
  ];
</script>
  ...
  <div class="max-w-6xl mx-auto px-6 lg:px-12">
    {#if isVisible}
      ...
      <div class="mb-16">
        ...
        >
          What AI Research Tools <span class="text-accent">Miss</span>
        </h2>
        <div
        ...
        >
          Perplexity, Grok, ChatGPT—they're powerful, but they can't access real
          data sources or research your market.
        </p>
      </div>
          ...
          >
            ...
            >
              <div class="flex items-start gap-5">
                <div
                  class="flex-shrink-0 w-12 h-12 rounded-lg flex items-center justify-center border transition-colors
									{activeTab === i
                    ? 'bg-accent/10 border-border-accent'
                    : 'bg-bg-surface border-border'}"
                >
                  <problem.icon
                    class="w-6 h-6 {activeTab === i
                      ? 'text-accent'
                      : 'text-text-muted'}"
                  />
                </div>
                ...
                <div class="flex-1">
                  ...
                  <div class="space-y-4">
                    <div class="flex items-start gap-3">
                      <div
                        class="flex-shrink-0 w-5 h-5 rounded-full bg-error/10 border border-error/50 flex items-center justify-center mt-0.5"
                      >
                        <X class="w-3 h-3 text-error" />
                      </div>
                      <div>
                        <span
                          class="text-xs text-error font-semibold uppercase tracking-wider"
                          >Deep Research</span
                        >
                    ...
                    <div class="flex items-start gap-3">
                      ...
                      <div>
                        <span
                          class="text-xs text-success font-semibold uppercase tracking-wider"
                          >NicheIQ</span
                        >
                        <p class="text-sm text-text-secondary font-mono mt-1">
                          {problem.nicheiq}
                        </p>
                      </div>
                    </div>
