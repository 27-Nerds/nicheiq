  ...
  <div class="max-w-4xl mx-auto px-6 lg:px-12">
    ...
    >
          ...
          <div class="flex-1">
            ...
            <h2
              class="font-display text-2xl sm:text-3xl lg:text-4xl font-bold text-text-primary mb-4 sm:mb-6"
            >
              Hi, I'm the solo dev behind NicheIQ
            </h2>

            <div
              class="space-y-3 sm:space-y-4 text-text-secondary leading-relaxed text-sm sm:text-base"
            >
              <p>
              ...
              <p>
                After researching my own SaaS ideas the hard way—manually
                reading hundreds of Reddit threads, cross-referencing keyword
                tools, and building spreadsheets—I decided to automate it.
              </p>
