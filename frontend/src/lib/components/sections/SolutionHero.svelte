<script lang="ts">
	...
	const extractDevTimeDuration = (devTime: string): { short: string; full: string } => {
	...
	{#if solution.estimated_development_time || solution.estimated_indexable_pages || solution.estimated_cac_organic}
		<div class="stats-row">
			{#if solution.estimated_development_time}
				{@const devTime = extractDevTimeDuration(solution.estimated_development_time)}
				<div class="stat-pill" title={devTime.short !== devTime.full ? devTime.full : undefined}>
					<Clock class="stat-icon" />
					<div class="stat-content">
						<span class="stat-value">{devTime.short}</span>
