...
5. It generates, checks, and ranks a varied set of candidate products. Grounded guidance may help you read the current pool, but it never changes the scores. (See [How ideas are generated](/help/idea-generation).)
