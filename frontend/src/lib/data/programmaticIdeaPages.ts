  ...
  },
  {
    ...
    faqJson: [
      ...
      },
      {
        ...
        a: 'It estimates whether a working version is technically possible with available models, integrations, and obtainable data. The displayed rating uses the same 0–100 scale as the rest of NicheIQ; build time and solo manageability are assessed separately.',
      },
      {
  ...
  },
  {
    ...
    faqJson: [
      ...
      },
      {
        ...
        a: 'It estimates whether one person can build and keep the product running, including support, uptime, moderation, maintenance, and marketing. The displayed rating uses NicheIQ’s 0–100 scale; lower ratings signal that the founder is likely to need help or significant infrastructure.',
      },
      {
