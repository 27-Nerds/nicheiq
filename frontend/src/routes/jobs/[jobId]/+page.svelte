  ...
  <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    {:else if error}
      <div class="card p-8 text-center">
        ...
        <a href="/" class="mt-6 btn-primary inline-block">Start New Research</a>
      </div>
    {:else if job}
      <!-- Header -->
      <div class="mb-8">
      ...
      <div class="card p-6 mb-6">
        ...
        <div class="w-full bg-bg-elevated rounded-full h-3 overflow-hidden">
          <div
            class="bg-gradient-to-r from-accent to-purple-500 h-3 rounded-full transition-all duration-500 ease-out"
