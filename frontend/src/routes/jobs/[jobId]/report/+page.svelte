<script lang="ts">
	...
	// Section components - Tier 1: Decision Layer
	...
	// Section components - Tier 2: Problem Analysis
	...
	// Section components - Tier 3: Technical & Implementation
	...
	// Section components - Tier 6: Execution
	...
	// Section components - Tier 7: Reference
...
{:else}
	<div class="report-layout">
		...
		<!-- Main Content -->
		<main class="report-content bg-mesh noise-overlay">
			<!-- Back to Job Link -->
